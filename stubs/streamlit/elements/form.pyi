...
class FormMixin:
    @gather_metrics("form")
    def form(self, key: str, clear_on_submit: bool = ..., *, enter_to_submit: bool = ..., border: bool = ..., width: Width = ..., height: Height = ...) -> DeltaGenerator:
    ...
    def form_submit_button(self, label: str = ..., help: str | None = ..., on_click: WidgetCallback | None = ..., args: WidgetArgs | None = ..., kwargs: WidgetKwargs | None = ..., *, type: Literal["primary", "secondary", "tertiary"] = ..., icon: str | None = ..., disabled: bool = ..., use_container_width: bool | None = ..., width: Width = ...) -> bool:

...
if TYPE_CHECKING:
    ...
NumberFormat: TypeAlias = Literal["plain", "localized", "dollar", "euro", "yen", "percent", "compact", "scientific", "engineering", "accounting", "bytes",]
ColumnWidth: TypeAlias = Union[Literal["small", "medium", "large"], int]
ColumnType: TypeAlias = Literal["object", "text", "number", "checkbox", "selectbox", "list", "datetime", "date", "time", "link", "line_chart", "bar_chart", "area_chart", "image", "progress", "json",]
...
class DatetimeColumnConfig(TypedDict):
    ...
    format: NotRequired[str | Literal["localized", "distance", "calendar", "iso8601"] | None]
...
class ColumnConfig(TypedDict, total=False):
    ...
    type_config: (NumberColumnConfig | TextColumnConfig | CheckboxColumnConfig | SelectboxColumnConfig | LinkColumnConfig | ListColumnConfig | DatetimeColumnConfig | DateColumnConfig | TimeColumnConfig | ProgressColumnConfig | LineChartColumnConfig | BarChartColumnConfig | AreaChartColumnConfig | ImageColumnConfig | JsonColumnConfig | None)
    ...


@gather_metrics("column_config.Column")
def Column(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ...) -> ColumnConfig:
...
def NumberColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ..., default: int | float | None = ..., format: str | NumberFormat | None = ..., min_value: int | float | None = ..., max_value: int | float | None = ..., step: int | float | None = ...) -> ColumnConfig:
...
def TextColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ..., default: str | None = ..., max_chars: int | None = ..., validate: str | None = ...) -> ColumnConfig:
...
def LinkColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ..., default: str | None = ..., max_chars: int | None = ..., validate: str | None = ..., display_text: str | None = ...) -> ColumnConfig:
...
def CheckboxColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ..., default: bool | None = ...) -> ColumnConfig:
...
def SelectboxColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ..., default: str | int | float | None = ..., options: Iterable[str | int | float] | None = ...) -> ColumnConfig:
...
def BarChartColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., pinned: bool | None = ..., y_min: int | float | None = ..., y_max: int | float | None = ...) -> ColumnConfig:
...
def LineChartColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., pinned: bool | None = ..., y_min: int | float | None = ..., y_max: int | float | None = ...) -> ColumnConfig:
...
def AreaChartColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., pinned: bool | None = ..., y_min: int | float | None = ..., y_max: int | float | None = ...) -> ColumnConfig:
...
def ImageColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., pinned: bool | None = ...) -> ColumnConfig:
...
def ListColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., pinned: bool | None = ...) -> ColumnConfig:
...
def DatetimeColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ..., default: datetime.datetime | None = ..., format: str | Literal["localized", "distance", "calendar", "iso8601"] | None = ..., min_value: datetime.datetime | None = ..., max_value: datetime.datetime | None = ..., step: int | float | datetime.timedelta | None = ..., timezone: str | None = ...) -> ColumnConfig:
...
def TimeColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ..., default: datetime.time | None = ..., format: str | Literal["localized", "iso8601"] | None = ..., min_value: datetime.time | None = ..., max_value: datetime.time | None = ..., step: int | float | datetime.timedelta | None = ...) -> ColumnConfig:
...
def DateColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., disabled: bool | None = ..., required: bool | None = ..., pinned: bool | None = ..., default: datetime.date | None = ..., format: str | Literal["localized", "distance", "iso8601"] | None = ..., min_value: datetime.date | None = ..., max_value: datetime.date | None = ..., step: int | None = ...) -> ColumnConfig:
...
def ProgressColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., pinned: bool | None = ..., format: str | NumberFormat | None = ..., min_value: int | float | None = ..., max_value: int | float | None = ..., step: int | float | None = ...) -> ColumnConfig:
...
def JsonColumn(label: str | None = ..., *, width: ColumnWidth | None = ..., help: str | None = ..., pinned: bool | None = ...) -> ColumnConfig:

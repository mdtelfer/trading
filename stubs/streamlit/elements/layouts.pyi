...
from streamlit.elements.lib.layout_utils import Gap, Height, HorizontalAlignment, VerticalAlignment, Width, WidthWithoutContent
...
class LayoutsMixin:
    ...
    def container(self, *, border: bool | None = ..., key: Key | None = ..., width: WidthWithoutContent = ..., height: Height = ..., horizontal: bool = ..., horizontal_alignment: HorizontalAlignment = ..., vertical_alignment: VerticalAlignment = ..., gap: Gap | None = ...) -> DeltaGenerator:
    ...
    def columns(self, spec: SpecType, *, gap: Gap | None = ..., vertical_alignment: Literal["top", "center", "bottom"] = ..., border: bool = ..., width: WidthWithoutContent = ...) -> list[DeltaGenerator]:
    ...
    @gather_metrics("tabs")
    def tabs(self, tabs: Sequence[str], *, width: WidthWithoutContent = ...) -> Sequence[DeltaGenerator]:
    ...
    def expander(self, label: str, expanded: bool = ..., *, icon: str | None = ..., width: WidthWithoutContent = ...) -> DeltaGenerator:
    ...
    def popover(self, label: str, *, help: str | None = ..., icon: str | None = ..., disabled: bool = ..., use_container_width: bool | None = ..., width: Width = ...) -> DeltaGenerator:
    ...
    def status(self, label: str, *, expanded: bool = ..., state: Literal["running", "complete", "error"] = ..., width: WidthWithoutContent = ...) -> StatusContainer:

...
class SQLConnection(BaseConnection["Engine"]):
    ...
    **Example 3: Configuration with keyword arguments**
    ...
    """
    def query(self, sql: str, *, show_spinner: bool | str = ..., ttl: float | int | timedelta | None = ..., index_col: str | list[str] | None = ..., chunksize: int | None = ..., params: Any | None = ..., **kwargs: Any) -> DataFrame:

...
if TYPE_CHECKING:
    ...
SQLSTATE_CONNECTION_WAS_NOT_ESTABLISHED: Final = ...
class SnowflakeConnection(BaseConnection["InternalSnowflakeConnection"]):
    ...
    **Example 6: Default connection in Snowflake's connection configuration file**
    ...
    """
    def query(self, sql: str, *, ttl: float | int | timedelta | None = ..., show_spinner: bool | str = ..., params: Any = ..., **kwargs: Any) -> DataFrame:
    ...
    def write_pandas(self, df: DataFrame, table_name: str, database: str | None = ..., schema: str | None = ..., chunk_size: int | None = ..., **kwargs: Any) -> tuple[bool, int, int]:

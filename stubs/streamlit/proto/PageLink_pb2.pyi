...
class PageLink(google.protobuf.message.Message):
    ...
    def __init__(self, *, page: builtins.str = ..., label: builtins.str = ..., icon: builtins.str = ..., page_script_hash: builtins.str = ..., help: builtins.str = ..., use_container_width: builtins.bool | None = ..., disabled: builtins.bool = ..., external: builtins.bool = ...) -> None:
        ...

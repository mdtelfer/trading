...
class VegaLiteChart(google.protobuf.message.Message):
    ...
    def __init__(self, *, spec: builtins.str = ..., data: streamlit.proto.DataFrame_pb2.DataFrame | None = ..., datasets: collections.abc.Iterable[streamlit.proto.NamedDataSet_pb2.NamedDataSet] | None = ..., use_container_width: builtins.bool = ...) -> None:
        ...

...
class DateInput(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: builtins.str = ..., label: builtins.str = ..., default: collections.abc.Iterable[builtins.str] | None = ..., min: builtins.str = ..., max: builtins.str = ..., is_range: builtins.bool = ..., help: builtins.str = ..., form_id: builtins.str = ..., value: collections.abc.Iterable[builtins.str] | None = ..., set_value: builtins.bool = ..., disabled: builtins.bool = ..., label_visibility: streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage | None = ..., format: builtins.str = ...) -> None:
        ...

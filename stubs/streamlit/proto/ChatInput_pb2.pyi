...
class ChatInput(google.protobuf.message.Message):
    ...
    class _PositionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ChatInput._Position.ValueType], builtins.type):
        ...
        BOTTOM: ChatInput._Position.ValueType
        ...
    ...
    BOTTOM: ChatInput.Position.ValueType
    class _AcceptFile:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    ...
    class _AcceptFileEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ChatInput._AcceptFile.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        NONE: ChatInput._AcceptFile.ValueType
        SINGLE: ChatInput._AcceptFile.ValueType
        MULTIPLE: ChatInput._AcceptFile.ValueType
        ...
    ...
    NONE: ChatInput.AcceptFile.ValueType
    SINGLE: ChatInput.AcceptFile.ValueType
    MULTIPLE: ChatInput.AcceptFile.ValueType
    ...
    def __init__(self, *, id: builtins.str = ..., placeholder: builtins.str = ..., max_chars: builtins.int = ..., disabled: builtins.bool = ..., value: builtins.str = ..., set_value: builtins.bool = ..., default: builtins.str = ..., position: global___ChatInput.Position.ValueType = ..., accept_file: global___ChatInput.AcceptFile.ValueType = ..., file_type: collections.abc.Iterable[builtins.str] | None = ..., max_upload_size_mb: builtins.int = ...) -> None:
        ...

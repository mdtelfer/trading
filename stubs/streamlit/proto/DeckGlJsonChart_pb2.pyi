...
class DeckGlJsonChart(google.protobuf.message.Message):
    ...
    class _SelectionModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[DeckGlJsonChart._SelectionMode.ValueType], builtins.type):
        ...
        SINGLE_OBJECT: DeckGlJsonChart._SelectionMode.ValueType
        MULTI_OBJECT: DeckGlJsonChart._SelectionMode.ValueType
        ...
    ...
    SINGLE_OBJECT: DeckGlJsonChart.SelectionMode.ValueType
    MULTI_OBJECT: DeckGlJsonChart.SelectionMode.ValueType
    ...
    def __init__(self, *, json: builtins.str = ..., tooltip: builtins.str = ..., use_container_width: builtins.bool = ..., id: builtins.str = ..., mapbox_token: builtins.str = ..., width: builtins.int = ..., height: builtins.int = ..., selection_mode: collections.abc.Iterable[global___DeckGlJsonChart.SelectionMode.ValueType] | None = ..., form_id: builtins.str = ...) -> None:
        ...

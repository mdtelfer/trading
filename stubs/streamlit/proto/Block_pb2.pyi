...
class Block(google.protobuf.message.Message):
    ...
    class Vertical(google.protobuf.message.Message):
        ...
        height: builtins.int
        def __init__(self, *, border: builtins.bool = ..., height: builtins.int = ...) -> None:
            ...
    ...
    class Horizontal(google.protobuf.message.Message):
        ...
        gap: builtins.str
        def __init__(self, *, gap: builtins.str = ...) -> None:
            ...
    ...
    class FlexContainer(google.protobuf.message.Message):
        ...
        class _DirectionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Block.FlexContainer._Direction.ValueType], builtins.type):
            ...
            DIRECTION_UNDEFINED: Block.FlexContainer._Direction.ValueType
            VERTICAL: Block.FlexContainer._Direction.ValueType
            HORIZONTAL: Block.FlexContainer._Direction.ValueType
            ...
        ...
        DIRECTION_UNDEFINED: Block.FlexContainer.Direction.ValueType
        VERTICAL: Block.FlexContainer.Direction.ValueType
        HORIZONTAL: Block.FlexContainer.Direction.ValueType
        class _Justify:
            ValueType = typing.NewType("ValueType", builtins.int)
            V: typing_extensions.TypeAlias = ValueType
        ...
        class _JustifyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Block.FlexContainer._Justify.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
            JUSTIFY_UNDEFINED: Block.FlexContainer._Justify.ValueType
            JUSTIFY_START: Block.FlexContainer._Justify.ValueType
            JUSTIFY_END: Block.FlexContainer._Justify.ValueType
            JUSTIFY_CENTER: Block.FlexContainer._Justify.ValueType
            SPACE_BETWEEN: Block.FlexContainer._Justify.ValueType
            ...
        ...
        JUSTIFY_UNDEFINED: Block.FlexContainer.Justify.ValueType
        JUSTIFY_START: Block.FlexContainer.Justify.ValueType
        JUSTIFY_END: Block.FlexContainer.Justify.ValueType
        JUSTIFY_CENTER: Block.FlexContainer.Justify.ValueType
        SPACE_BETWEEN: Block.FlexContainer.Justify.ValueType
        class _Align:
            ValueType = typing.NewType("ValueType", builtins.int)
            V: typing_extensions.TypeAlias = ValueType
        ...
        class _AlignEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Block.FlexContainer._Align.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
            ALIGN_UNDEFINED: Block.FlexContainer._Align.ValueType
            ALIGN_START: Block.FlexContainer._Align.ValueType
            ALIGN_END: Block.FlexContainer._Align.ValueType
            ALIGN_CENTER: Block.FlexContainer._Align.ValueType
            STRETCH: Block.FlexContainer._Align.ValueType
            ...
        ...
        ALIGN_UNDEFINED: Block.FlexContainer.Align.ValueType
        ALIGN_START: Block.FlexContainer.Align.ValueType
        ALIGN_END: Block.FlexContainer.Align.ValueType
        ALIGN_CENTER: Block.FlexContainer.Align.ValueType
        STRETCH: Block.FlexContainer.Align.ValueType
        BORDER_FIELD_NUMBER: builtins.int
        ...
        def __init__(self, *, border: builtins.bool = ..., gap_config: streamlit.proto.GapSize_pb2.GapConfig | None = ..., scale: builtins.float = ..., direction: global___Block.FlexContainer.Direction.ValueType = ..., wrap: builtins.bool = ..., justify: global___Block.FlexContainer.Justify.ValueType = ..., align: global___Block.FlexContainer.Align.ValueType = ...) -> None:
            ...
    ...
    class Column(google.protobuf.message.Message):
        ...
        class _VerticalAlignmentEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Block.Column._VerticalAlignment.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
            TOP: Block.Column._VerticalAlignment.ValueType
            CENTER: Block.Column._VerticalAlignment.ValueType
            BOTTOM: Block.Column._VerticalAlignment.ValueType
            ...
        ...
        TOP: Block.Column.VerticalAlignment.ValueType
        CENTER: Block.Column.VerticalAlignment.ValueType
        BOTTOM: Block.Column.VerticalAlignment.ValueType
        ...
        def __init__(self, *, weight: builtins.float = ..., gap: builtins.str = ..., vertical_alignment: global___Block.Column.VerticalAlignment.ValueType = ..., show_border: builtins.bool = ..., gap_config: streamlit.proto.GapSize_pb2.GapConfig | None = ...) -> None:
            ...
    ...
    class Expandable(google.protobuf.message.Message):
        ...
        icon: builtins.str
        def __init__(self, *, label: builtins.str = ..., expanded: builtins.bool | None = ..., icon: builtins.str = ...) -> None:
            ...
    ...
    class Dialog(google.protobuf.message.Message):
        ...
        class _DialogWidthEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Block.Dialog._DialogWidth.ValueType], builtins.type):
            ...
            LARGE: Block.Dialog._DialogWidth.ValueType
            ...
        ...
        SMALL: Block.Dialog.DialogWidth.ValueType
        LARGE: Block.Dialog.DialogWidth.ValueType
        ...
        id: builtins.str
        def __init__(self, *, title: builtins.str = ..., dismissible: builtins.bool = ..., width: global___Block.Dialog.DialogWidth.ValueType = ..., is_open: builtins.bool | None = ..., id: builtins.str = ...) -> None:
            ...
    ...
    class Form(google.protobuf.message.Message):
        ...
        def __init__(self, *, form_id: builtins.str = ..., clear_on_submit: builtins.bool = ..., border: builtins.bool = ..., enter_to_submit: builtins.bool = ...) -> None:
            ...
    ...
    class Popover(google.protobuf.message.Message):
        ...
        icon: builtins.str
        def __init__(self, *, label: builtins.str = ..., use_container_width: builtins.bool = ..., help: builtins.str = ..., disabled: builtins.bool = ..., icon: builtins.str = ...) -> None:
            ...
    ...
    class ChatMessage(google.protobuf.message.Message):
        ...
        class _AvatarTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Block.ChatMessage._AvatarType.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
            IMAGE: Block.ChatMessage._AvatarType.ValueType
            EMOJI: Block.ChatMessage._AvatarType.ValueType
            ICON: Block.ChatMessage._AvatarType.ValueType
            ...
        ...
        IMAGE: Block.ChatMessage.AvatarType.ValueType
        EMOJI: Block.ChatMessage.AvatarType.ValueType
        ICON: Block.ChatMessage.AvatarType.ValueType
        ...
        def __init__(self, *, name: builtins.str = ..., avatar: builtins.str = ..., avatar_type: global___Block.ChatMessage.AvatarType.ValueType = ...) -> None:
            ...
    ...
    def __init__(self, *, vertical: global___Block.Vertical | None = ..., horizontal: global___Block.Horizontal | None = ..., column: global___Block.Column | None = ..., expandable: global___Block.Expandable | None = ..., form: global___Block.Form | None = ..., tab_container: global___Block.TabContainer | None = ..., tab: global___Block.Tab | None = ..., chat_message: global___Block.ChatMessage | None = ..., popover: global___Block.Popover | None = ..., dialog: global___Block.Dialog | None = ..., flex_container: global___Block.FlexContainer | None = ..., allow_empty: builtins.bool = ..., id: builtins.str | None = ..., height_config: streamlit.proto.HeightConfig_pb2.HeightConfig | None = ..., width_config: streamlit.proto.WidthConfig_pb2.WidthConfig | None = ...) -> None:
        ...

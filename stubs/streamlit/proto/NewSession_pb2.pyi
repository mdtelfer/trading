...
class NewSession(google.protobuf.message.Message):
    ...
    def __init__(self, *, initialize: global___Initialize | None = ..., script_run_id: builtins.str = ..., name: builtins.str = ..., main_script_path: builtins.str = ..., config: global___Config | None = ..., custom_theme: global___CustomThemeConfig | None = ..., app_pages: collections.abc.Iterable[streamlit.proto.AppPage_pb2.AppPage] | None = ..., page_script_hash: builtins.str = ..., fragment_ids_this_run: collections.abc.Iterable[builtins.str] | None = ..., main_script_hash: builtins.str = ...) -> None:
        ...
...
class Initialize(google.protobuf.message.Message):
    ...
    def __init__(self, *, user_info: global___UserInfo | None = ..., environment_info: global___EnvironmentInfo | None = ..., session_status: streamlit.proto.SessionStatus_pb2.SessionStatus | None = ..., command_line: builtins.str = ..., session_id: builtins.str = ..., is_hello: builtins.bool = ...) -> None:
        ...
...
class Config(google.protobuf.message.Message):
    ...
    class _ToolbarModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Config._ToolbarMode.ValueType], builtins.type):
        ...
        AUTO: Config._ToolbarMode.ValueType
        DEVELOPER: Config._ToolbarMode.ValueType
        VIEWER: Config._ToolbarMode.ValueType
        MINIMAL: Config._ToolbarMode.ValueType
        ...
    ...
    AUTO: Config.ToolbarMode.ValueType
    DEVELOPER: Config.ToolbarMode.ValueType
    VIEWER: Config.ToolbarMode.ValueType
    MINIMAL: Config.ToolbarMode.ValueType
    ...
    def __init__(self, *, gather_usage_stats: builtins.bool = ..., max_cached_message_age: builtins.int = ..., mapbox_token: builtins.str = ..., allow_run_on_save: builtins.bool = ..., hide_top_bar: builtins.bool = ..., hide_sidebar_nav: builtins.bool = ..., toolbar_mode: global___Config.ToolbarMode.ValueType = ...) -> None:
        ...
...
class CustomThemeConfig(google.protobuf.message.Message):
    ...
    class _BaseThemeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[CustomThemeConfig._BaseTheme.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LIGHT: CustomThemeConfig._BaseTheme.ValueType
        DARK: CustomThemeConfig._BaseTheme.ValueType
        ...
    ...
    LIGHT: CustomThemeConfig.BaseTheme.ValueType
    DARK: CustomThemeConfig.BaseTheme.ValueType
    class _FontFamily:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    ...
    class _FontFamilyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[CustomThemeConfig._FontFamily.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        SANS_SERIF: CustomThemeConfig._FontFamily.ValueType
        SERIF: CustomThemeConfig._FontFamily.ValueType
        MONOSPACE: CustomThemeConfig._FontFamily.ValueType
        ...
    ...
    SANS_SERIF: CustomThemeConfig.FontFamily.ValueType
    SERIF: CustomThemeConfig.FontFamily.ValueType
    MONOSPACE: CustomThemeConfig.FontFamily.ValueType
    ...
    def __init__(self, *, primary_color: builtins.str = ..., secondary_background_color: builtins.str = ..., background_color: builtins.str = ..., text_color: builtins.str = ..., font: global___CustomThemeConfig.FontFamily.ValueType = ..., base: global___CustomThemeConfig.BaseTheme.ValueType = ..., widget_background_color: builtins.str = ..., widget_border_color: builtins.str = ..., radii: global___Radii | None = ..., heading_font: builtins.str = ..., body_font: builtins.str = ..., code_font: builtins.str = ..., font_faces: collections.abc.Iterable[global___FontFace] | None = ..., font_sizes: global___FontSizes | None = ..., skeleton_background_color: builtins.str = ..., base_radius: builtins.str | None = ..., button_radius: builtins.str | None = ..., border_color: builtins.str | None = ..., dataframe_border_color: builtins.str | None = ..., show_widget_border: builtins.bool | None = ..., link_color: builtins.str | None = ..., link_underline: builtins.bool | None = ..., base_font_size: builtins.int | None = ..., base_font_weight: builtins.int | None = ..., code_font_weight: builtins.int | None = ..., code_font_size: builtins.str | None = ..., heading_font_sizes: collections.abc.Iterable[builtins.str] | None = ..., heading_font_weights: collections.abc.Iterable[builtins.int] | None = ..., show_sidebar_border: builtins.bool | None = ..., sidebar: global___CustomThemeConfig | None = ..., code_background_color: builtins.str | None = ..., dataframe_header_background_color: builtins.str | None = ..., chart_categorical_colors: collections.abc.Iterable[builtins.str] | None = ..., chart_sequential_colors: collections.abc.Iterable[builtins.str] | None = ...) -> None:
        ...
...
class FontFace(google.protobuf.message.Message):
    ...
    def __init__(self, *, url: builtins.str = ..., family: builtins.str = ..., weight: builtins.int = ..., weight_range: builtins.str = ..., style: builtins.str = ..., unicode_range: builtins.str = ...) -> None:
        ...
...
class Radii(google.protobuf.message.Message):
    ...
    def __init__(self, *, base_widget_radius: builtins.int = ..., checkbox_radius: builtins.int = ...) -> None:
        ...
...
class FontSizes(google.protobuf.message.Message):
    ...
    base_font_size: builtins.int
    def __init__(self, *, tiny_font_size: builtins.int = ..., small_font_size: builtins.int = ..., base_font_size: builtins.int = ...) -> None:
        ...
...
class UserInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, installation_id: builtins.str = ..., installation_id_v3: builtins.str = ..., installation_id_v4: builtins.str = ...) -> None:
        ...
...
class EnvironmentInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, streamlit_version: builtins.str = ..., python_version: builtins.str = ..., server_os: builtins.str = ..., has_display: builtins.bool = ...) -> None:
        ...

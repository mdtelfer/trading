...
class ButtonGroup(google.protobuf.message.Message):
    ...
    class _ClickModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ButtonGroup._ClickMode.ValueType], builtins.type):
        ...
        SINGLE_SELECT: ButtonGroup._ClickMode.ValueType
        MULTI_SELECT: ButtonGroup._ClickMode.ValueType
        ...
    ...
    SINGLE_SELECT: ButtonGroup.ClickMode.ValueType
    MULTI_SELECT: ButtonGroup.ClickMode.ValueType
    ...
    class _SelectionVisualizationEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ButtonGroup._SelectionVisualization.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        ONLY_SELECTED: ButtonGroup._SelectionVisualization.ValueType
        ALL_UP_TO_SELECTED: ButtonGroup._SelectionVisualization.ValueType
        ...
    ...
    ONLY_SELECTED: ButtonGroup.SelectionVisualization.ValueType
    ALL_UP_TO_SELECTED: ButtonGroup.SelectionVisualization.ValueType
    class _Style:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    ...
    class _StyleEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ButtonGroup._Style.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        SEGMENTED_CONTROL: ButtonGroup._Style.ValueType
        PILLS: ButtonGroup._Style.ValueType
        BORDERLESS: ButtonGroup._Style.ValueType
        ...
    ...
    SEGMENTED_CONTROL: ButtonGroup.Style.ValueType
    PILLS: ButtonGroup.Style.ValueType
    BORDERLESS: ButtonGroup.Style.ValueType
    @typing.final
    class Option(google.protobuf.message.Message):
        ...
        def __init__(self, *, content: builtins.str = ..., selected_content: builtins.str | None = ..., content_icon: builtins.str | None = ..., selected_content_icon: builtins.str | None = ...) -> None:
            ...
    ...
    def __init__(self, *, id: builtins.str = ..., options: collections.abc.Iterable[global___ButtonGroup.Option] | None = ..., default: collections.abc.Iterable[builtins.int] | None = ..., disabled: builtins.bool = ..., click_mode: global___ButtonGroup.ClickMode.ValueType = ..., form_id: builtins.str = ..., value: collections.abc.Iterable[builtins.int] | None = ..., set_value: builtins.bool = ..., selection_visualization: global___ButtonGroup.SelectionVisualization.ValueType = ..., style: global___ButtonGroup.Style.ValueType = ..., label: builtins.str = ..., label_visibility: streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage | None = ..., help: builtins.str | None = ...) -> None:
        ...

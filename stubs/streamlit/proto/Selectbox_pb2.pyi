...
class Selectbox(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: builtins.str = ..., label: builtins.str = ..., default: builtins.int | None = ..., options: collections.abc.Iterable[builtins.str] | None = ..., help: builtins.str = ..., form_id: builtins.str = ..., value: builtins.int | None = ..., raw_value: builtins.str | None = ..., set_value: builtins.bool = ..., disabled: builtins.bool = ..., label_visibility: streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage | None = ..., placeholder: builtins.str = ..., accept_new_options: builtins.bool | None = ...) -> None:
        ...

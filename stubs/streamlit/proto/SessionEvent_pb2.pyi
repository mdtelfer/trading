...
class SessionEvent(google.protobuf.message.Message):
    ...
    def __init__(self, *, script_changed_on_disk: builtins.bool = ..., script_was_manually_stopped: builtins.bool = ..., script_compilation_exception: streamlit.proto.Exception_pb2.Exception | None = ...) -> None:
        ...

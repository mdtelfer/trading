...
class Skeleton(google.protobuf.message.Message):
    ...
    class _SkeletonStyleEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Skeleton._SkeletonStyle.ValueType], builtins.type):
        ...
        ELEMENT: Skeleton._SkeletonStyle.ValueType
        APP: Skeleton._SkeletonStyle.ValueType
        ...
    ...
    ELEMENT: Skeleton.SkeletonStyle.ValueType
    APP: Skeleton.SkeletonStyle.ValueType
    STYLE_FIELD_NUMBER: builtins.int
    HEIGHT_FIELD_NUMBER: builtins.int
    style: global___Skeleton.SkeletonStyle.ValueType
    height: builtins.int
    def __init__(self, *, style: global___Skeleton.SkeletonStyle.ValueType = ..., height: builtins.int | None = ...) -> None:
        ...

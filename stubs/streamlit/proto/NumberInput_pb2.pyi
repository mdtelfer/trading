...
class NumberInput(google.protobuf.message.Message):
    ...
    class _DataTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[NumberInput._DataType.ValueType], builtins.type):
        ...
        INT: NumberInput._DataType.ValueType
        FLOAT: NumberInput._DataType.ValueType
        ...
    ...
    INT: NumberInput.DataType.ValueType
    FLOAT: NumberInput.DataType.ValueType
    ...
    def __init__(self, *, id: builtins.str = ..., label: builtins.str = ..., form_id: builtins.str = ..., format: builtins.str = ..., has_min: builtins.bool = ..., has_max: builtins.bool = ..., data_type: global___NumberInput.DataType.ValueType = ..., default: builtins.float | None = ..., step: builtins.float = ..., min: builtins.float = ..., max: builtins.float = ..., help: builtins.str = ..., value: builtins.float | None = ..., set_value: builtins.bool = ..., disabled: builtins.bool = ..., label_visibility: streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage | None = ..., placeholder: builtins.str = ..., icon: builtins.str = ...) -> None:
        ...

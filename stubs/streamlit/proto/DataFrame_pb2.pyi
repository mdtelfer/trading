...
class DataFrame(google.protobuf.message.Message):
    ...
    def __init__(self, *, data: global___Table | None = ..., index: global___Index | None = ..., columns: global___Index | None = ..., style: global___TableStyle | None = ...) -> None:
        ...
...
class Index(google.protobuf.message.Message):
    ...
    def __init__(self, *, plain_index: global___PlainIndex | None = ..., range_index: global___RangeIndex | None = ..., multi_index: global___MultiIndex | None = ..., datetime_index: global___DatetimeIndex | None = ..., timedelta_index: global___TimedeltaIndex | None = ..., int_64_index: global___Int64Index | None = ..., float_64_index: global___Float64Index | None = ...) -> None:
        ...
...
class PlainIndex(google.protobuf.message.Message):
    ...
    def __init__(self, *, data: global___AnyArray | None = ...) -> None:
        ...
...
class RangeIndex(google.protobuf.message.Message):
    ...
    start: builtins.int
    stop: builtins.int
    def __init__(self, *, start: builtins.int = ..., stop: builtins.int = ...) -> None:
        ...
...
class MultiIndex(google.protobuf.message.Message):
    ...
    def __init__(self, *, levels: collections.abc.Iterable[global___Index] | None = ..., labels: collections.abc.Iterable[streamlit.proto.Common_pb2.Int32Array] | None = ...) -> None:
        ...
...
class DatetimeIndex(google.protobuf.message.Message):
    ...
    def __init__(self, *, data: streamlit.proto.Common_pb2.StringArray | None = ...) -> None:
        ...
...
class TimedeltaIndex(google.protobuf.message.Message):
    ...
    def __init__(self, *, data: streamlit.proto.Common_pb2.Int64Array | None = ...) -> None:
        ...
...
class Float64Index(google.protobuf.message.Message):
    ...
    def __init__(self, *, data: streamlit.proto.Common_pb2.DoubleArray | None = ...) -> None:
        ...
...
class CSSStyle(google.protobuf.message.Message):
    ...
    value: builtins.str
    def __init__(self, *, property: builtins.str = ..., value: builtins.str = ...) -> None:
        ...
...
class CellStyle(google.protobuf.message.Message):
    ...
    def __init__(self, *, css: collections.abc.Iterable[global___CSSStyle] | None = ..., display_value: builtins.str = ..., has_display_value: builtins.bool = ...) -> None:
        ...
...
class CellStyleArray(google.protobuf.message.Message):
    ...
    def __init__(self, *, styles: collections.abc.Iterable[global___CellStyle] | None = ...) -> None:
        ...
...
class AnyArray(google.protobuf.message.Message):
    ...
    def __init__(self, *, strings: streamlit.proto.Common_pb2.StringArray | None = ..., doubles: streamlit.proto.Common_pb2.DoubleArray | None = ..., int64s: streamlit.proto.Common_pb2.Int64Array | None = ..., datetimes: streamlit.proto.Common_pb2.StringArray | None = ..., timedeltas: streamlit.proto.Common_pb2.Int64Array | None = ...) -> None:
        ...
...
class Table(google.protobuf.message.Message):
    ...
    def __init__(self, *, cols: collections.abc.Iterable[global___AnyArray] | None = ...) -> None:
        ...
...
class TableStyle(google.protobuf.message.Message):
    ...
    def __init__(self, *, cols: collections.abc.Iterable[global___CellStyleArray] | None = ...) -> None:
        ...

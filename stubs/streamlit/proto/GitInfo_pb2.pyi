...
class GitInfo(google.protobuf.message.Message):
    ...
    class _GitStatesEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[GitInfo._GitStates.ValueType], builtins.type):
        ...
        DEFAULT: GitInfo._GitStates.ValueType
        HEAD_DETACHED: GitInfo._GitStates.ValueType
        AHEAD_OF_REMOTE: GitInfo._GitStates.ValueType
        ...
    ...
    DEFAULT: GitInfo.GitStates.ValueType
    HEAD_DETACHED: GitInfo.GitStates.ValueType
    AHEAD_OF_REMOTE: GitInfo.GitStates.ValueType
    ...
    def __init__(self, *, repository: builtins.str = ..., branch: builtins.str = ..., module: builtins.str = ..., untracked_files: collections.abc.Iterable[builtins.str] | None = ..., uncommitted_files: collections.abc.Iterable[builtins.str] | None = ..., state: global___GitInfo.GitStates.ValueType = ...) -> None:
        ...

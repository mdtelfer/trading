...
class Navigation(google.protobuf.message.Message):
    ...
    class _PositionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Navigation._Position.ValueType], builtins.type):
        ...
        HIDDEN: Navigation._Position.ValueType
        SIDEBAR: Navigation._Position.ValueType
        TOP: Navigation._Position.ValueType
        ...
    ...
    HIDDEN: Navigation.Position.ValueType
    SIDEBAR: Navigation.Position.ValueType
    TOP: Navigation.Position.ValueType
    ...
    def __init__(self, *, sections: collections.abc.Iterable[builtins.str] | None = ..., app_pages: collections.abc.Iterable[streamlit.proto.AppPage_pb2.AppPage] | None = ..., position: global___Navigation.Position.ValueType = ..., page_script_hash: builtins.str = ..., expanded: builtins.bool = ...) -> None:
        ...

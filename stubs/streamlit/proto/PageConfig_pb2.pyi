...
class PageConfig(google.protobuf.message.Message):
    ...
    class _LayoutEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PageConfig._Layout.ValueType], builtins.type):
        ...
        CENTERED: PageConfig._Layout.ValueType
        WIDE: PageConfig._Layout.ValueType
        LAYOUT_UNSET: PageConfig._Layout.ValueType
        ...
    ...
    CENTERED: PageConfig.Layout.ValueType
    WIDE: PageConfig.Layout.ValueType
    LAYOUT_UNSET: PageConfig.Layout.ValueType
    class _SidebarState:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    ...
    class _SidebarStateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PageConfig._SidebarState.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        AUTO: PageConfig._SidebarState.ValueType
        EXPANDED: PageConfig._SidebarState.ValueType
        COLLAPSED: PageConfig._SidebarState.ValueType
        SIDEBAR_UNSET: PageConfig._SidebarState.ValueType
        ...
    ...
    AUTO: PageConfig.SidebarState.ValueType
    EXPANDED: PageConfig.SidebarState.ValueType
    COLLAPSED: PageConfig.SidebarState.ValueType
    SIDEBAR_UNSET: PageConfig.SidebarState.ValueType
    @typing.final
    class MenuItems(google.protobuf.message.Message):
        ...
        def __init__(self, *, get_help_url: builtins.str = ..., hide_get_help: builtins.bool = ..., report_a_bug_url: builtins.str = ..., hide_report_a_bug: builtins.bool = ..., about_section_md: builtins.str = ..., clear_about_md: builtins.bool = ...) -> None:
            ...
    ...
    def __init__(self, *, title: builtins.str = ..., favicon: builtins.str = ..., layout: global___PageConfig.Layout.ValueType = ..., initial_sidebar_state: global___PageConfig.SidebarState.ValueType = ..., menu_items: global___PageConfig.MenuItems | None = ...) -> None:
        ...

...
class TextInput(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[TextInput._Type.ValueType], builtins.type):
        ...
        DEFAULT: TextInput._Type.ValueType
        PASSWORD: TextInput._Type.ValueType
        ...
    ...
    DEFAULT: TextInput.Type.ValueType
    PASSWORD: TextInput.Type.ValueType
    ...
    def __init__(self, *, id: builtins.str = ..., label: builtins.str = ..., default: builtins.str | None = ..., type: global___TextInput.Type.ValueType = ..., max_chars: builtins.int = ..., help: builtins.str = ..., form_id: builtins.str = ..., value: builtins.str | None = ..., set_value: builtins.bool = ..., autocomplete: builtins.str = ..., placeholder: builtins.str = ..., disabled: builtins.bool = ..., label_visibility: streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage | None = ..., icon: builtins.str = ...) -> None:
        ...

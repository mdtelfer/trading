...
class Slider(google.protobuf.message.Message):
    ...
    class _DataTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Slider._DataType.ValueType], builtins.type):
        ...
        INT: Slider._DataType.ValueType
        FLOAT: Slider._DataType.ValueType
        DATETIME: Slider._DataType.ValueType
        DATE: Slider._DataType.ValueType
        TIME: Slider._DataType.ValueType
        ...
    ...
    INT: Slider.DataType.ValueType
    FLOAT: Slider.DataType.ValueType
    DATETIME: Slider.DataType.ValueType
    DATE: Slider.DataType.ValueType
    TIME: Slider.DataType.ValueType
    class _Type:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Slider._Type.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        UNSPECIFIED: Slider._Type.ValueType
        SLIDER: Slider._Type.ValueType
        SELECT_SLIDER: Slider._Type.ValueType
        ...
    ...
    UNSPECIFIED: Slider.Type.ValueType
    SLIDER: Slider.Type.ValueType
    SELECT_SLIDER: Slider.Type.ValueType
    ...
    def __init__(self, *, id: builtins.str = ..., form_id: builtins.str = ..., label: builtins.str = ..., format: builtins.str = ..., data_type: global___Slider.DataType.ValueType = ..., default: collections.abc.Iterable[builtins.float] | None = ..., min: builtins.float = ..., max: builtins.float = ..., step: builtins.float = ..., value: collections.abc.Iterable[builtins.float] | None = ..., set_value: builtins.bool = ..., options: collections.abc.Iterable[builtins.str] | None = ..., help: builtins.str = ..., disabled: builtins.bool = ..., label_visibility: streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage | None = ..., type: global___Slider.Type.ValueType = ...) -> None:
        ...

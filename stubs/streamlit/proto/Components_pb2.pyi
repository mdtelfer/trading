...
class ComponentInstance(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: builtins.str = ..., json_args: builtins.str = ..., special_args: collections.abc.Iterable[global___SpecialArg] | None = ..., component_name: builtins.str = ..., url: builtins.str = ..., form_id: builtins.str = ..., tab_index: builtins.int | None = ...) -> None:
        ...
...
class SpecialArg(google.protobuf.message.Message):
    ...
    def __init__(self, *, key: builtins.str = ..., arrow_dataframe: global___ArrowDataframe | None = ..., bytes: builtins.bytes = ...) -> None:
        ...
...
class ArrowDataframe(google.protobuf.message.Message):
    ...
    def __init__(self, *, data: global___ArrowTable | None = ..., height: builtins.int = ..., width: builtins.int = ...) -> None:
        ...
...
class ArrowTable(google.protobuf.message.Message):
    ...
    def __init__(self, *, data: builtins.bytes = ..., index: builtins.bytes = ..., columns: builtins.bytes = ..., styler: global___ArrowTableStyler | None = ...) -> None:
        ...

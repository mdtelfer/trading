...
class PlotlyChart(google.protobuf.message.Message):
    ...
    class _SelectionModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PlotlyChart._SelectionMode.ValueType], builtins.type):
        ...
        POINTS: PlotlyChart._SelectionMode.ValueType
        BOX: PlotlyChart._SelectionMode.ValueType
        LASSO: PlotlyChart._SelectionMode.ValueType
        ...
    ...
    POINTS: PlotlyChart.SelectionMode.ValueType
    BOX: PlotlyChart.SelectionMode.ValueType
    LASSO: PlotlyChart.SelectionMode.ValueType
    ...
    def __init__(self, *, use_container_width: builtins.bool = ..., theme: builtins.str = ..., id: builtins.str = ..., selection_mode: collections.abc.Iterable[global___PlotlyChart.SelectionMode.ValueType] | None = ..., form_id: builtins.str = ..., spec: builtins.str = ..., config: builtins.str = ..., url: builtins.str = ..., figure: global___Figure | None = ...) -> None:
        ...
...
class Figure(google.protobuf.message.Message):
    ...
    spec: builtins.str
    config: builtins.str
    def __init__(self, *, spec: builtins.str = ..., config: builtins.str = ...) -> None:
        ...

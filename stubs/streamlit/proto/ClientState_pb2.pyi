...
class ContextInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, timezone: builtins.str | None = ..., timezone_offset: builtins.int | None = ..., locale: builtins.str | None = ..., url: builtins.str | None = ..., is_embedded: builtins.bool | None = ..., color_scheme: builtins.str | None = ...) -> None:
        ...
...
class ClientState(google.protobuf.message.Message):
    ...
    def __init__(self, *, query_string: builtins.str = ..., widget_states: streamlit.proto.WidgetStates_pb2.WidgetStates | None = ..., page_script_hash: builtins.str = ..., page_name: builtins.str = ..., fragment_id: builtins.str = ..., is_auto_rerun: builtins.bool = ..., cached_message_hashes: collections.abc.Iterable[builtins.str] | None = ..., context_info: global___ContextInfo | None = ...) -> None:
        ...

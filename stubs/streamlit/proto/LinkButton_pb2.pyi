...
class LinkButton(google.protobuf.message.Message):
    ...
    type: builtins.str
    icon: builtins.str
    def __init__(self, *, label: builtins.str = ..., help: builtins.str = ..., url: builtins.str = ..., disabled: builtins.bool = ..., use_container_width: builtins.bool = ..., type: builtins.str = ..., icon: builtins.str = ...) -> None:
        ...

...
class ArrowVegaLiteChart(google.protobuf.message.Message):
    ...
    def __init__(self, *, spec: builtins.str = ..., data: streamlit.proto.Arrow_pb2.Arrow | None = ..., datasets: collections.abc.Iterable[streamlit.proto.ArrowNamedDataSet_pb2.ArrowNamedDataSet] | None = ..., use_container_width: builtins.bool = ..., theme: builtins.str = ..., id: builtins.str = ..., selection_mode: collections.abc.Iterable[builtins.str] | None = ..., form_id: builtins.str = ...) -> None:
        ...

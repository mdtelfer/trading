...
class Exception(google.protobuf.message.Message):
    ...
    def __init__(self, *, type: builtins.str = ..., message: builtins.str = ..., message_is_markdown: builtins.bool = ..., stack_trace: collections.abc.Iterable[builtins.str] | None = ..., is_warning: builtins.bool = ..., width_config: streamlit.proto.WidthConfig_pb2.WidthConfig | None = ...) -> None:
        ...

...
class FileUploader(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: builtins.str = ..., label: builtins.str = ..., type: collections.abc.Iterable[builtins.str] | None = ..., max_upload_size_mb: builtins.int = ..., multiple_files: builtins.bool = ..., help: builtins.str = ..., form_id: builtins.str = ..., disabled: builtins.bool = ..., label_visibility: streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage | None = ...) -> None:
        ...

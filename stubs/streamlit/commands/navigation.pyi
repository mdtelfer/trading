...
def convert_to_streamlit_page(page_input: PageType) -> StreamlitPage:
    """Convert various input types to StreamlitPage objects."""
    ...

def pages_from_nav_sections(nav_sections: dict[SectionHeader, list[StreamlitPage]]) -> list[StreamlitPage]:
    ...
...
def navigation(pages: Sequence[PageType] | Mapping[SectionHeader, Sequence[PageType]], *, position: Literal["sidebar", "hidden", "top"] = ..., expanded: bool = ...) -> StreamlitPage:
    """

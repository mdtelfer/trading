...
def set_page_config(page_title: str | None = ..., page_icon: PageIcon | None = ..., layout: Layout | None = ..., initial_sidebar_state: InitialSideBarState | None = ..., menu_items: MenuItems | None = ...) -> None:
    """
...
def set_menu_items_proto(lowercase_menu_items: MenuItems, menu_items_proto: PageConfigProto.MenuItems) -> None:
    ...

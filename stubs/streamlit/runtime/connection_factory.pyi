...
from typing import Any, Final, Literal, TYPE_CHECKING, TypeVar, overload
from streamlit.connections import BaseConnection, SQLConnection, SnowflakeConnection, SnowparkConnection
from datetime import timedelta

if TYPE_CHECKING:
    ...
_FIRST_PARTY_CONNECTIONS: Final[dict[str, type[BaseConnection[Any]]]] = ...
_MODULE_EXTRACTION_REGEX = ...
_MODULES_TO_PYPI_PACKAGES: Final[dict[str, str]] = ...
_USE_ENV_PREFIX: Final = ...
ConnectionClass = TypeVar("ConnectionClass", bound=BaseConnection[Any])
@overload
def connection_factory(name: Literal["sql"], max_entries: int | None = ..., ttl: float | timedelta | None = ..., autocommit: bool = ..., **kwargs: Any) -> SQLConnection:
    ...

@overload
def connection_factory(name: str, type: Literal["sql"], max_entries: int | None = ..., ttl: float | timedelta | None = ..., autocommit: bool = ..., **kwargs: Any) -> SQLConnection:
    ...

@overload
def connection_factory(name: Literal["snowflake"], max_entries: int | None = ..., ttl: float | timedelta | None = ..., autocommit: bool = ..., **kwargs: Any) -> SnowflakeConnection:
    ...

@overload
def connection_factory(name: str, type: Literal["snowflake"], max_entries: int | None = ..., ttl: float | timedelta | None = ..., autocommit: bool = ..., **kwargs: Any) -> SnowflakeConnection:
    ...

@overload
def connection_factory(name: Literal["snowpark"], max_entries: int | None = ..., ttl: float | timedelta | None = ..., **kwargs: Any) -> SnowparkConnection:
    ...

@overload
def connection_factory(name: str, type: Literal["snowpark"], max_entries: int | None = ..., ttl: float | timedelta | None = ..., **kwargs: Any) -> SnowparkConnection:
    ...

@overload
def connection_factory(name: str, type: type[ConnectionClass], max_entries: int | None = ..., ttl: float | timedelta | None = ..., **kwargs: Any) -> ConnectionClass:
    ...

@overload
def connection_factory(name: str, type: str | None = ..., max_entries: int | None = ..., ttl: float | timedelta | None = ..., **kwargs: Any) -> BaseConnection[Any]:
    ...

def connection_factory(name, type=..., max_entries=..., ttl=..., **kwargs): # -> SnowparkConnection | Any | BaseConnection[Any]:
